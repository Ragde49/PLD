...
Public Class handler_peso_cliente_pf
        ...
        Select Case op
            ...
            Case "consultar"
                ...
                Using conn As New SqlConnection(ConfigurationManager.ConnectionStrings("PLDConnection").ConnectionString)
                    ...
                    ' Convertimos la estructura vertical en horizontal
                    Dim sql As String = "
                        SELECT categoria,
            ...
            Case "actualizar"
                ...
                ' Mapeamos el campo al nivel correcto
                Dim nivel As String = ""
                ...
                Using conn As New SqlConnection(ConfigurationManager.ConnectionStrings("PLDConnection").ConnectionString)
                    conn.Open()
                    Dim sql As String = "UPDATE config_peso_cliente_pf SET valor = @valor, fecha_actualizacion = GETDATE() WHERE categoria = @categoria AND nivel = @nivel"
                    Using cmd As New SqlCommand(sql, conn)
